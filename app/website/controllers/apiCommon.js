...
ApiCommon.prototype.get_apiPermissions = function (req, res, next) {

    var self = this;
    var params = [{ name: 'idEmpresa', value: req.query.idEmpresa, type: self.model.types.INT },
    { name: 'idTipoPopliza', value: req.query.idTipoPopliza, type: self.model.types.INT }
    ];
    self.model.queryAllRecordSet('usp_get_permisosApi', params, function (error, result) {
        self.view.expositor(res, {
            error: error,
            result: result
        });
